...
class dynamicaly_calculate_nine_one_rule:
    ...
    if __name__ == '__main__':
        ...
        sub_output_dir = "{}/{}/".format(output_dir, stock_symbol)
        ...
        input_df = web.DataReader(stock_symbol, data_source='yahoo', start=start_date, end=end_date)
